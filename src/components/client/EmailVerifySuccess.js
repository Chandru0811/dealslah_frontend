        ...
        >
            ...
            >
                <div className="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p className="text-center my-3">We're grateful to welcome you as a Dealslah vendor.</p>
                    <p className="text-center">Start your journey with us and explore new sales opportunities.</p>
                    <Link to='/'>
