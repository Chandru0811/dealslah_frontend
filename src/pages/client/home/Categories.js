...
function Categories() {
    ...
    return (
        <section>
            <div className='container-fluid my-4'>
                <div className='row d-flex justify-content-center mt-4'>
                    ...
                    <div className='col-lg-1 col-md-2 col-3 text-center'>
                        <div className='card categoryCard' onClick={handleAllCategoriesClick}>
            ...
            {/* Offcanvas Component */}
            <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasCategories" aria-labelledby="offcanvasCategoriesLabel">
                <div className="offcanvas-header">
                    <h4 className="offcanvas-title fw-bold" id="offcanvasCategoriesLabel">All Categories</h4>
                    <button type="button" className="btn-close text-reset" onClick={handleOffcanvasClose} aria-label="Close"></button>
                </div>
